...
from utils import img_show, all_image_concat
...
def main():
    ...
    for t in tqdm(range(args.num_img)):
        ...
        all_images_show.save(os.path.join(args.save_path,f'effect_show-{args.model}-{t}.jpg'))
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num_img', type=int, help='imgsz', default=4)
    argparser.add_argument('--attack_iter', type=int, default=50)
    argparser.add_argument('--save_path', type=str,default='./output/')
